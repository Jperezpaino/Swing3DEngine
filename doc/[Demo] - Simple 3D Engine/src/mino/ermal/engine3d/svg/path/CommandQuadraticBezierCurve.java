...
import mino.ermal.engine3d.svg.path.interfaces.PathCommand;
   ...
   *
   */
  public class CommandQuadraticBezierCurve
     ...
     *
     */
    public CommandQuadraticBezierCurve() {
      this(
        new Position()
      );
    }
     ...
     */
    public CommandQuadraticBezierCurve(
        final CommandQuadraticBezierCurve _command) {
      this( 
        _command.position()
      );
    }
     ...
     */
    public final CommandQuadraticBezierCurve command() {
      return this;
    }
    ...
    public final boolean equals(
      ...
      final CommandQuadraticBezierCurve command
        = (CommandQuadraticBezierCurve) _command;
      return
