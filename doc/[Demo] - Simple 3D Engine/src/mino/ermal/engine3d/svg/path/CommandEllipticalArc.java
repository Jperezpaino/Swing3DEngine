...
import mino.ermal.engine3d.svg.path.interfaces.PathCommand;
   ...
   *
   */
  public class CommandEllipticalArc
     ...
     */
    public CommandEllipticalArc(
        final CommandEllipticalArc _command) {
      this( 
        _command.position()
      );
    }
     ...
     */
    public final CommandEllipticalArc command() {
      return this;
    }
    ...
    public final boolean equals(
      ...
      final CommandEllipticalArc command
        = (CommandEllipticalArc) _command;
      return
