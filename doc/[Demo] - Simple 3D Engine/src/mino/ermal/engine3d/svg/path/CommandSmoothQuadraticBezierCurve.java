...
import mino.ermal.engine3d.svg.path.interfaces.PathCommand;
   ...
   *
   */
  public class CommandSmoothQuadraticBezierCurve
     ...
     *
     */
    public CommandSmoothQuadraticBezierCurve() {
      this(
        new Position()
      );
    }
     ...
     */
    public CommandSmoothQuadraticBezierCurve(
        final CommandSmoothQuadraticBezierCurve _command) {
      this( 
        _command.position()
      );
    }
     ...
     */
    public final CommandSmoothQuadraticBezierCurve command() {
      return this;
    }
    ...
    public final boolean equals(
      ...
      final CommandSmoothQuadraticBezierCurve command
        = (CommandSmoothQuadraticBezierCurve) _command;
      return
