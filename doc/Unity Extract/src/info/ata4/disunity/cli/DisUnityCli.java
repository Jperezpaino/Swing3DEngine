...
public class DisUnityCli {
    ...
    public static void main(String[] args) {
        ...
        args2[1] = "list";
        args2[2] = "d";
        args2[3] = "C:/Desarrollo/Workspace-core/Unity Extract/res/actors0.unity3d";

        String[] args3 = new String[3];
        args3[0] = "asset";
        args3[1] = "blocks";
        args3[2] = "C:/Desarrollo/Workspace-core/Unity Extract/res/actors0/CAB-ad3409a66a9478169ecdcc0ff568e9cf.resS";
