package es.noa.rad.demos.color;
...
import
 ...
 public class Board extends Panel {
  ...
  private void drawComponent(final Graphics graphics) {
   ...
   int elementDefaultWidth = 25;
   int elementDefaultHeight = 25;
   ...
   elementPositionX = elementPositionX + elementDefaultWidth;
   ...
   elementPositionX = elementPositionX + elementDefaultWidth;
   graphics2D.setColor(new Color(0, 0, 0, 0.20F));
   graphics2D.fillRect(
    elementPositionX, elementPositionY,  
    elementDefaultWidth, elementDefaultHeight);
      
   elementPositionX = elementPositionX + elementDefaultWidth;
   graphics2D.setColor(new Color(0, 0, 0, 0.40F));
   graphics2D.fillRect(
    elementPositionX, elementPositionY,  
    elementDefaultWidth, elementDefaultHeight);
      
   elementPositionX = elementPositionX + elementDefaultWidth;
   graphics2D.setColor(new Color(0, 0, 0, 0.60F));
   graphics2D.fillRect(
    elementPositionX, elementPositionY,  
    elementDefaultWidth, elementDefaultHeight);
   ...
   /**/
   elementPositionX = 0;   
   elementPositionY = elementPositionY + elementDefaultWidth;   
   ...
   elementPositionX = 0;
   elementPositionY = elementPositionY + elementDefaultWidth;
   graphics2D.setColor(new Color(255, 175, 175));
   graphics2D.fillRect(
    elementPositionX, elementPositionY,  
    elementDefaultWidth, elementDefaultHeight); 
  ...
  elementPositionX = elementPositionX + elementDefaultWidth;
  graphics2D.setColor(new Color(0.0f, 0.90f, 0.90f));
  float[] colores = new float[3];
  System.out.println(Color.RGBtoHSB(Color.PINK.getRed(), Color.PINK.getGreen(), Color.PINK.getBlue(), colores));
  graphics2D.fillRect(
   elementPositionX, elementPositionY,  
   elementDefaultWidth, elementDefaultHeight);
   ...
   elementPositionX = elementPositionX + elementDefaultWidth;
   graphics2D.setColor(new Color(0, 255, 128));
   graphics2D.fillRect(
    elementPositionX, elementPositionY,  
    elementDefaultWidth, elementDefaultHeight);
   ...
   elementPositionX = elementPositionX + elementDefaultWidth;
   graphics2D.setColor(new Color(128, 255, 0));
   graphics2D.fillRect(
    elementPositionX, elementPositionY,  
    elementDefaultWidth, elementDefaultHeight);
   ...
   elementPositionX = elementPositionX + elementDefaultWidth;
   graphics2D.setColor(new Color(128, 128, 0));
   graphics2D.fillRect(
    elementPositionX, elementPositionY,  
    elementDefaultWidth, elementDefaultHeight); 
   ...
   elementPositionX = elementPositionX + elementDefaultWidth;
   graphics2D.setColor(new Color(128, 255, 255));
   graphics2D.fillRect(
    elementPositionX, elementPositionY,  
    elementDefaultWidth, elementDefaultHeight);   
   ...
   elementPositionX = elementPositionX + elementDefaultWidth;
   graphics2D.setColor(new Color(255, 128, 255));
   graphics2D.fillRect(
    elementPositionX, elementPositionY,  
    elementDefaultWidth, elementDefaultHeight);   
