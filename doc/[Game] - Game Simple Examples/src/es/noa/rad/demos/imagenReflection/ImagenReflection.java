package es.noa.rad.demos.imagenReflection;
 ...
 public class ImagenReflection extends JFrame {
  private static final long serialVersionUID = 1L;

  public ImagenReflection() {
   /*
  ...
  private void initUI() {
    ...
    * la ventana.
    */
   this.setTitle("Imagen Reflection Demo");
   /*
  ...
  public static void main(String[] args) {
   ...
   EventQueue.invokeLater(
    new Runnable() {
     public void run() {
      ImagenReflection imagenReflectionDemo = new ImagenReflection();
      imagenReflectionDemo.setVisible(true);
     }
    }
   );
  }
