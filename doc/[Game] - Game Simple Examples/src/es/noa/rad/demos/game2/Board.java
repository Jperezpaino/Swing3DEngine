...
public class Board extends JPanel implements ActionListener {
    ...
    private void loadImages() {
        ...
        ImageIcon iid = new ImageIcon(".//res//snake//dot.png");
        ball = iid.getImage();

        ImageIcon iia = new ImageIcon(".//res//snake//apple.png");
        apple = iia.getImage();

        ImageIcon iih = new ImageIcon(".//res//snake//head.png");
        head = iih.getImage();
    }
...
/*
 irst we will define the constants used in our game.
