package es.noa.rad.demos.timerframerateflickering;
 ...
 public class TimerFrameRateFlickering extends JFrame {
  private static final long serialVersionUID = 1L;

  public TimerFrameRateFlickering() {
   /*
  ...
  public static void main(String[] args) {
   ...
   EventQueue.invokeLater(
    new Runnable() {
     public void run() {
      TimerFrameRateFlickering timerFrameRateFlickeringDemo = new TimerFrameRateFlickering();
      timerFrameRateFlickeringDemo.setVisible(true);
     }
    }
   );
  }
