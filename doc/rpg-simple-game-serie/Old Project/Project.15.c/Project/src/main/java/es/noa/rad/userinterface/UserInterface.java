...
public class UserInterface {
  ...
  public final void drawDialogueScreen() {
    ...
    final int xMessage = (x + this.gamePanel.tileSize);
    final int yMessage = (y + this.gamePanel.tileSize);
    
    this.graphics2D.setFont(this.arial32);
    this.graphics2D.drawString(this.currentDialogue, xMessage, yMessage);
  }
