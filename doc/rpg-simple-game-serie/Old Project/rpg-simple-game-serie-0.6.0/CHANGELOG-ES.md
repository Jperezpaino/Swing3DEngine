...
El sistema de mapas actual es muy limitado, por lo tanto, implementamos un 
sistema de carga de mundos, que permita cargar mapas mayores al tamaño de la 
pantalla y a su vez un sistema de cámaras que establecerá al jugador en el 
centro de la pantalla y nos permita desplazar a este a lo largo del mundo, 
desplazando el mundo en relación con la posición del jugador.

**Video**: _(RyiSnow) - How to Make a 2D Game in Java - Part 5 - World and Camera.mp4_

## [0.5.1] - 04-10-2023 (98,7 %)

En la versión anterior establecimos los controles para el jugador, y en esta 
versión implementamos los controles para el mapa tanto su carga como de qué 
manera debe dibujarse.

**Video**: _(RyiSnow) - How to Make a 2D Game in Java - Part 5 - World and Camera.mp4_

## [0.5.2] - 05-10-2023 (98,7 %)

Tenemos una versión funcional paro para nada optima ya que dibuja todas las 
'tiles' estén o no estén dentro da la pantalla, optimizamos la manera de 
dibujar el mapa no pintando las 'tiles' que quedan fuera de la cámara y 
únicamente centrándonos en la que si quedan dentro de la cámara.

**Video**: _(RyiSnow) - How to Make a 2D Game in Java - Part 5 - World and Camera.mp4_

## [0.5.3] - 06-10-2023 (98,7 %)

Siguiendo con el desarrollo anterior podemos observar que al ajustarnos al 
tamaño exacto de la pantalla obtenemos un borde negro, sin 'tiles' dibujadas, 
esto se debe al propio desplazamiento, ya que al final origina 'tiles' que 
están dibujadas a caballo entre los bordes, es decir sus coordenadas de 
posición están fuera del área de dibujado, pero partes de la 'tile' están 
dentro de esta área por lo tanto es necesario extender este área para que este 
tipo de situación entren en las operaciones de dibujado y no sean excluidas.
