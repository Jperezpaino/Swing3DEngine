...
import es.noa.rad.game.rpgs2d.KeyHandler;
  ...
  public class Player
     ...
     *
     */
    private static final Rectangle PLAYER_SOLID_AREA
      = new Rectangle(9, 24, 30, 24);
    ...
    public final void init() {
      ...
      super.setWorldY(
       ...
       - (this.gamePanel.getTileSize() / 2)));
      super.setSolidArea(Player.PLAYER_SOLID_AREA);
      super.setSpeed(Player.PLAYER_SPEED);
    }
    ...
    public final void update() {
      if (this.keyHandler.isUpPressed()
       ...
       || this.keyHandler.isRightPressed()) {
        ...
        /* Check the collisions between the player and the destination tiles. */
        super.setCollision(false);
        this.gamePanel.getCollisionChecker().checkEntityTileCollision(this);
