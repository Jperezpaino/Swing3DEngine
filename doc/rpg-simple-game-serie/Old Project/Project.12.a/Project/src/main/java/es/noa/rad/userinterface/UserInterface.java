...
public class UserInterface {
  ...
  public final void draw(
    ...
    if (this.gameFinished) {
      ...
      text = "Your Time is " + this.decimalFormat.format(this.playTime) + "!";
      textLength = ((int) (graphics2D.getFontMetrics().getStringBounds(text, graphics2D).getWidth()));
      x = ((this.gamePanel.screenWidth / 2) - (textLength / 2));
      y = ((this.gamePanel.screenHeight / 2) + (this.gamePanel.tileSize * 4));
      graphics2D.drawString(text, x, y);
      ...
      graphics2D.drawString("Time:" + this.decimalFormat.format(this.playTime), (this.gamePanel.tileSize * 11), 65);
