...
//  public int hasKey = 0;
  ...
  public void getPlayerImage() {
    super.up1 = setup("walking/up_1");
    super.up2 = setup("walking/up_2");
    super.down1 = setup("walking/down_1");
    super.down2 = setup("walking/down_2");
    super.left1 = setup("walking/left_1");
    super.left2 = setup("walking/left_2");
    super.right1 = setup("walking/right_1");
    super.right2 = setup("walking/right_2");
  }
