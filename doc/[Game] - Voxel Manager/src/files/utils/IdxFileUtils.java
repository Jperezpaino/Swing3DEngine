...
public class IdxFileUtils {
  
  public static int getUnsignedByte(byte byteValue) {
   return (byteValue & 0xFF);
  }
  
  public static int getUnsignedByte(byte[] bytesValue) {
   ByteBuffer wrapped = ByteBuffer.wrap(bytesValue); // big-endian by default
