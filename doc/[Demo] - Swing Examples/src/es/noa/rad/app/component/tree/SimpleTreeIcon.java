...
import
 ...
 public class SimpleTreeIcon extends JPanel {
  ...
  private static void createAndShowGUI() {
    ...
    */
   mainFrame.add(new SimpleTreeIcon());
  ...
  protected static ImageIcon createImageIcon(String path) {
      java.net.URL imgURL = SimpleTreeIcon.class.getResource(path);
      if (imgURL != null) {
