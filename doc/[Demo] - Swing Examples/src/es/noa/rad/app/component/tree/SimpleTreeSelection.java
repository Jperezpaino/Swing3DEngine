...
import
 ...
 public class SimpleTreeSelection extends JPanel
                                  implements TreeSelectionListener {
  private static final long serialVersionUID = 1L;
  private static final String WINDOW_NAME = "Simple Tree Selection Example";
  ...
  public SimpleTreeSelection() {
   ...
   // Añadimos un 'Listener' para la selección de elementos del arbol. */
  ...
  private static void createAndShowGUI() {
    ...
    */
   mainFrame.add(new SimpleTreeSelection());
  ...
  public final void valueChanged(
         final TreeSelectionEvent treeSelectionEventParam) {
