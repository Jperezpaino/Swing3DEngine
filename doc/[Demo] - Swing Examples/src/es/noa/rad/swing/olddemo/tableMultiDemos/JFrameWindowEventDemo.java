...
public class JFrameWindowEventDemo extends JFrame
        implements WindowListener,
        WindowFocusListener,
        WindowStateListener {
    static final String newline = System.getProperty("line.separator");
    static final  String space = "    ";
    static JFrameWindowEventDemo frame = new JFrameWindowEventDemo("WindowEventDemo");
    JTextArea display;
   ...
   /**
    ...
    public JFrameWindowEventDemo(String name) {
        super(name);
    }
