 ...
 * Instancia la vista y el modelo, adem�s de meter la vista en un JFrame y
 * mostrarlo en pantalla.
 * 
 * La vista ser�n dos JComboBox. El primero permite elegir valores pares o
 * impares. El segundo cambiar� al seleccionar pares o impares en el primero. Si
 * se seleccionan pares, el segundo combo box mostrar� 2,4,6. Si se seleccionan
 * impares, mostrar� 1,3,5. La Vista sera "tonta", es decir, no tendra ningun
