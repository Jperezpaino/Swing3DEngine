...
public class EjemplosJOptionPane {
    ...
    protected void muestraDialogoModal(ActionEvent evento) {
        ...
        // aplicacion,
        // pero hacemos aqu� este c�digo un poco m�s general, para ver c�mo se
        ...
        // que el dialogo modal se oculte. Por ello, a continuaci�n tenemos
